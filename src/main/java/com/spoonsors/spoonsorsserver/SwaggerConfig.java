...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private static final String SERVICE_NAME = "모두의 한 끼";
    private static final String API_VERSION = "V1";
    private static final String API_DESCRIPTION = "모두의 한 끼 API TEST";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.
                        basePackage("com.spoonsors.spoonsorsserver.controller")) // RequestMapping의 모든 URL LIST
